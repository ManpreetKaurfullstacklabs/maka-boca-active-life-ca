        ...
        <div className="signup-container">
            {!formSubmitted ? <div className="signup-box">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <input type="text" name="gender" className="input-field" placeholder="Gender" onChange={handleChange} required />
                    ...
                    <input type="text" name="bussinessPhoneNo" className="input-field" placeholder="Business Phone No" onChange={handleChange} />
                    <input type="text" name="homePhoneNo" className="input-field" placeholder="Home Phone No" onChange={handleChange} />
